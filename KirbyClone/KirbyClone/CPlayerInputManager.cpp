...
void CPlayerInputManager::UpdateInputFlags ( )
{
    ...
    {
        // ANY_MOVEMENT는 이미 개별 입력들로 구성되어있으므로 별도 처리 불필요
    }
}
